...
C_SRCS += \
../User/LCD_I2C/LCD_I2C.c 

OBJS += \
./User/LCD_I2C/LCD_I2C.o 

C_DEPS += \
./User/LCD_I2C/LCD_I2C.d 


# Each subdirectory must supply rules for building sources it contributes
User/LCD_I2C/%.o User/LCD_I2C/%.su User/LCD_I2C/%.cyclo: ../User/LCD_I2C/%.c User/LCD_I2C/subdir.mk
...
clean: clean-User-2f-LCD_I2C

clean-User-2f-LCD_I2C:
	-$(RM) ./User/LCD_I2C/LCD_I2C.cyclo ./User/LCD_I2C/LCD_I2C.d ./User/LCD_I2C/LCD_I2C.o ./User/LCD_I2C/LCD_I2C.su

.PHONY: clean-User-2f-LCD_I2C
