...
C_SRCS += \
../User/PassiveBuzzer/BUZZER.c 

OBJS += \
./User/PassiveBuzzer/BUZZER.o 

C_DEPS += \
./User/PassiveBuzzer/BUZZER.d 


# Each subdirectory must supply rules for building sources it contributes
User/PassiveBuzzer/%.o User/PassiveBuzzer/%.su User/PassiveBuzzer/%.cyclo: ../User/PassiveBuzzer/%.c User/PassiveBuzzer/subdir.mk
...
clean: clean-User-2f-PassiveBuzzer

clean-User-2f-PassiveBuzzer:
	-$(RM) ./User/PassiveBuzzer/BUZZER.cyclo ./User/PassiveBuzzer/BUZZER.d ./User/PassiveBuzzer/BUZZER.o ./User/PassiveBuzzer/BUZZER.su

.PHONY: clean-User-2f-PassiveBuzzer
